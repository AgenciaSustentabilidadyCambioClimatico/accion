Rails.application.configure do
  ...
  email = YAML.safe_load_file(ERB.new(File.read("#{Dir.pwd}/config/email.yml")).result, aliases: true)
  ...
  # config.active_job.queue_name_prefix = "ascc_#{Rails.env}"
  config.action_mailer.perform_caching = false
  ...
  config.oob_uri = 'https://dev-accion.ascc.cl/oauth2callback'
end
