...
#   devise_for :users, path: '', path_names: path_names
 ...
 #  resources :cargos, except: [:show] do
  ...
  get 'verificar_auditor_existente/:id', to: 'fondo_produccion_limpias#verificar_auditor_existente', as: :verificar_auditor_existente_fondo_produccion_limpia
  ...
  post 'subir_documento_refresh_pagina', to: 'fondo_produccion_limpias#subir_documento_refresh_pagina', as: :subir_documento_refresh_pagina
  ...
  get 'eliminar_plan_actividades/:id', to: "fondo_produccion_limpias#eliminar_plan_actividades", as: :eliminar_plan_actividades_fondo_produccion_limpia
  delete '/eliminar_plan_actividades/:id', to: 'fondo_produccion_limpias#eliminar_plan_actividades', as: 'eliminar_plan_actividades'
