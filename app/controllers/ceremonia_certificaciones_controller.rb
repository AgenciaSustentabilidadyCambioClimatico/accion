      ...
      format.js {
        ...
        if @convocatoria.save
          ...
          @convocatoria.convocatoria_destinatarios.each do |rd|
            ...
            ConvocatoriaMailer.enviar(rd, @convocatoria.mensaje_encabezado, @convocatoria.mensaje_cuerpo, @convocatoria.archivo_adjunto, rgc.id).deliver_now # DZC 2018-10-11 12:08:19 se corrige error en nombre de variable rgc.id
          end
