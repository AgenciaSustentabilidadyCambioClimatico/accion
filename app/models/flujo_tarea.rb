				...
				if sig_tarea.cualquiera_con_rol_o_usuario_asignado
                  ...
                  puts 'Enviando mails 1 ves'
									FlujoMailer.enviar(
										...
										rgc.id).deliver_later #DZC 2018-10-05 13:12:23 se agrega id para efectos instanciar la ruta a la imágen asociada al registro del receptor del corren en tabla RegistroAperturaCorreo
								end
							end   
							if !auditorias.blank? #DZC elimina el último elemento del array
								auditorias.pop
